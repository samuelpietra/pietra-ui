...
export const Color: Story = {
  render: () => (
    <Flex direction="column">
      <Text color="indigo">The quick brown fox jumps over the indigo color.</Text>
      <Text color="cyan">The quick brown fox jumps over the cyan color.</Text>
      <Text color="orange">The quick brown fox jumps over the orange color.</Text>
      <Text color="crimson">The quick brown fox jumps over the crimson color.</Text>
    </Flex>
  ),
};
      ...
      <Flex
        ...
        <Text as="label" size="3">
          <Flex gap="2">
            ...
            I understand that these documents are
